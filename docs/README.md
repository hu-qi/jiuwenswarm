...
* **附录**：提供与项目使用和维护相关的补充资料，包括打包 EXE、Windows 自动更新设计、企业级部署、企业级用户手册和开发者文档。
...
<table width="100%" style="display: table; width: 100%; table-layout: fixed;">
  ...
  <tbody>
    ...
    <tr>
      <td width="22%"><strong>企业级文档</strong></td>
      <td width="28%"><a href="zh/企业级K8S部署手册.md">企业级 K8S 部署手册</a> / <a href="zh/企业级用户使用手册.md">企业级用户使用手册</a></td>
      <td width="50%">企业环境下的 K8S 部署流程、启动验证、用户使用和常见问题排查。</td>
    </tr>
    <tr>
